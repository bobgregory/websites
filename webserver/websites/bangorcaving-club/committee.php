...
<head>
    ...
    <link rel="stylesheet" href="sources/stylesheets/committee.css">
...
<body>
    ...
    <main>
        <div>
            <h2>President - Luke Khulmann</h2>
            <p1>More Khulmanns</p1>
        ...
        <div>
            <h2>Tackle Mistress - Sion Du</h2>
            <p1>Go and wash your kit</p1>
        ...
        <div>
            ...
            <p1>Please send in photos and flavour texts/little bios</p1>
            <img src="sources/committee/web.png"    onerror="if (this.src != 'sources/committee/blank.png') this.src = 'sources/committee/blank.png';">
        </div>
    </main>
